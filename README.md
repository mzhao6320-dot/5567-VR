...
backup 3: python vr_node.py --id 3 --port 6003 --peer_ports 6000,6001,6002,6003,6004
backup 4: python vr_node.py --id 1 --port 6004 --peer_ports 6000,6001,6002,6003,6004
primary: list
primary: status
primary: data
backup: status
